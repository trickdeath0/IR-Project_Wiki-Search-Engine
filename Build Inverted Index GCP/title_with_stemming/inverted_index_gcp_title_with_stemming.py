...
class MultiFileWriter:
    ...
    def upload_to_gcp(self):
        ...
        blob = self.bucket.blob(f"postings_gcp_title_with_stemming/{file_name}") # TODO:: change to postings_gcp_title/ posting_gcp_body / posting_gcp_anchor
    ...
    def read(self, locs, n_bytes):
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
                #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                gs_name = f"postings_gcp_title_with_stemming/{f_name}"
...
class InvertedIndex:  
    ...
    def posting_lists_iter(self, file_name):
        """ A generator that reads one posting list from disk and yields 
            a (word:str, [(doc_id:int, tf:int), ...]) tuple.
        """
        with closing(MultiFileReader(file_name)) as reader:
    ...
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    def read_posting_list(self, w, file_name):
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name):
        ...
        blob_posting_locs = bucket.blob(f"postings_gcp_title_with_stemming/{bucket_id}_posting_locs.pickle") # TODO: change to title / anchor
